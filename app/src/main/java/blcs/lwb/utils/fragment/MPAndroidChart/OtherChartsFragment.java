package blcs.lwb.utils.fragment.MPAndroidChart;
...
public class OtherChartsFragment extends DemoBase {
    ...
    protected int bindLayout() {
        return R.layout.fragment_other_charts;
    }
    ...
    private void initMenu() {
        activity.tlToolbar.inflateMenu(R.menu.combined);

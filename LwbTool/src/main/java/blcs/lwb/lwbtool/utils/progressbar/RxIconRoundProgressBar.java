...
import blcs.lwb.lwbtool.utils.progressbar.common.RxBaseRoundProgressBar;
...
public class RxIconRoundProgressBar extends RxBaseRoundProgressBar implements View.OnClickListener {
    ...
    protected void initStyleable(Context context, AttributeSet attrs) {
        ...
        iconResource = typedArray.getResourceId(R.styleable.IconRoundCornerProgress_rcIconSrc, R.mipmap.set);

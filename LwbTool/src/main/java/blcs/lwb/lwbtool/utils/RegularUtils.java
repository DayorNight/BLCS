 ...
 * 1、验证手机号（简单）
 * 2、验证手机号（精确）
 * 3、验证座机号,正确格式：xxx/xxxx-xxxxxxx/xxxxxxxx/
 * 4、验证邮箱
 * 5、验证url
 * 6、验证汉字
 * 7、验证用户名,取值范围为a-z,A-Z,0-9,"_",汉字，不能以"_"结尾,用户名必须是6-20位
 * 8、验证IP地址
 * 9、是否符合手机号（简单）格式
 * 10、是否符合手机号（精确）格式
 * 11、是否符合座机号码格式
 ...
 * 14、是否符合汉字
 * 15、是否符合用户名
 * 16、如果str 符合 regex的正则表达式格式,返回true, 否则返回 false;
 */
...
public class RegularUtils {
     ...
     * @return 16、如果str 符合 regex的正则表达式格式,返回true, 否则返回 false;
     */

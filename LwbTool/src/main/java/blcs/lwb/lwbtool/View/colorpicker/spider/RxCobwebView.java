...
public class RxCobwebView extends View {
    ...
    private void initEvent() {
        defalutSize = DensityUtils.dp2px(mContext,defalutSize);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        //标题字体大小
        mSpiderNameSize = a.getDimensionPixelSize(R.styleable.RxCobwebView_spiderNameSize, DensityUtils.dp2px(mContext,16));
        a.recycle();
    }

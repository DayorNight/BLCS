...
import blcs.lwb.lwbtool.bean.ThreadBean;
...
public class ThreadManager {
	...
	public Handler runThread(String name, Runnable runnable) {
		if (StringUtils.isNotEmpty(name, true) == false || runnable == null) {
			Log.e(TAG, "runThread  StringUtils.isNotEmpty(name, true) == false || runnable == null >> return");
			return null;
		}
	...
	private void destroyThread(ThreadBean tb) {
		...
		if (tb.getName() != null) { // StringUtils.isNotEmpty(tb.getName(), true)) {
